  ...
  <div class="content-wrapper"  style="margin-left: -0px;">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Jenjang Pendidikan</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <form role="form">-->
              <div class="box-body">
                <div id="tablejenjang_pendidikan">
                </div>
              </div>
              <!-- /.box-body 
        ...
        <div class="col-md-4">
          ...
          <div class="box box-info">
            ...
            /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" enctype="multipart/form-data" novalidate id="formjenjang_pendidikan">
              <div class="box-body">
...
<script>  
          refresh();
            ...
            function ubahjenjang_pendidikan(a,b){                
            ...
            function simpanubah(){
                  ...
                  //alert('pages/jenjang_pendidikan/jenjang_pendidikan_edit_save.php?kode='+kode+'&nama='+nama+'&kodehid='+kodehid+'&namahid='+namahid);
                   $.ajax({
                                url: 'pages/jenjang_pendidikan/jenjang_pendidikan_edit_save.php?kode='+kode+'&nama='+nama+'&kodehid='+kodehid+'&namahid='+namahid,
                                type: 'GET',
                                success: function (data){               
                                  ...
                                  refresh();
                                  $("#tablejenjang_pendidikan").load('pages/jenjang_pendidikan/jenjang_pendidikan_load.php');
            ...
            $(document).ready(function (){
                 $("#tablejenjang_pendidikan").load('pages/jenjang_pendidikan/jenjang_pendidikan_load.php');
                    ...
                    $("#formjenjang_pendidikan").on('submit', function(e){
                          e.preventDefault();
                                      $.ajax({
                                                  type: 'POST',
                                                  url: 'pages/jenjang_pendidikan/jenjang_pendidikan_add_save.php',
