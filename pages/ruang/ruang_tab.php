      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-info">
            ...
            /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" enctype="multipart/form-data" novalidate id="formruang">
              <div class="box-body">
...
<script>  
          refresh();
            ...
            function simpanubah(){
                  ...
                  //alert('pages/ruang/ruang_edit_save.php?kode='+kode+'&nama='+nama+'&kodehid='+kodehid+'&namahid='+namahid);
                   $.ajax({
                                url: 'pages/ruang/ruang_edit_save.php?kode='+kode+'&nama='+nama+'&kodehid='+kodehid+'&namahid='+namahid,
                                type: 'GET',
                                success: function (data){               
                                  ...
                                  refresh();
                                  $("#tableruang").load('pages/ruang/ruang_load.php');
                 ...
                 $("#tableruang").load('pages/ruang/ruang_load.php');
                    ...
                    $("#formruang").on('submit', function(e){
                          e.preventDefault();
                                      $.ajax({
                                                  type: 'POST',
                                                  url: 'pages/ruang/ruang_add_save.php',
