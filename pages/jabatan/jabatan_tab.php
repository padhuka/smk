...
<script>  
          refresh();
            ...
            function simpanubah(){
                  ...
                  //alert('pages/jabatan/jabatan_edit_save.php?kode='+kode+'&nama='+nama+'&kodehid='+kodehid+'&namahid='+namahid);
                   $.ajax({
                                url: 'pages/jabatan/jabatan_edit_save.php?kode='+kode+'&nama='+nama+'&kodehid='+kodehid+'&namahid='+namahid,
                                type: 'GET',
                 ...
                 $("#tablejabatan").load('pages/jabatan/jabatan_load.php');
                    ...
                    $("#formjabatan").on('submit', function(e){
                          e.preventDefault();
                                      $.ajax({
                                                  type: 'POST',
                                                  url: 'pages/jabatan/jabatan_add_save.php',
