      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-info">
            ...
            /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" enctype="multipart/form-data" novalidate id="formjenis_pembayaran">
              <div class="box-body">
...
<script>  
          refresh();
            ...
            function ubahjenis_pembayaran(a,b){                
            ...
            function simpanubah(){
                  ...
                  //alert('pages/jenis_pembayaran/jenis_pembayaran_edit_save.php?kode='+kode+'&nama='+nama+'&kodehid='+kodehid+'&namahid='+namahid);
                   $.ajax({
                                url: 'pages/jenis_pembayaran/jenis_pembayaran_edit_save.php?kode='+kode+'&nama='+nama+'&kodehid='+kodehid+'&namahid='+namahid,
                                type: 'GET',
                                success: function (data){               
                                  ...
                                  refresh();
                                  $("#tablejenis_pembayaran").load('pages/jenis_pembayaran/jenis_pembayaran_load.php');
            ...
            $(document).ready(function (){
                 $("#tablejenis_pembayaran").load('pages/jenis_pembayaran/jenis_pembayaran_load.php');
                    ...
                    $("#formjenis_pembayaran").on('submit', function(e){
                          e.preventDefault();
                                      $.ajax({
                                                  type: 'POST',
                                                  url: 'pages/jenis_pembayaran/jenis_pembayaran_add_save.php',
