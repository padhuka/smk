  ...
  <div class="content-wrapper"  style="margin-left: -0px;">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Bidang Studi</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-info">
            ...
            /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" enctype="multipart/form-data" novalidate id="formbidang_studi">
              <div class="box-body">
...
<script>  
          refresh();
            ...
            function simpanubah(){
                  ...
                  //alert('pages/bidang_studi/bidang_studi_edit_save.php?kode='+kode+'&nama='+nama+'&kodehid='+kodehid+'&namahid='+namahid);
                   $.ajax({
                                url: 'pages/bidang_studi/bidang_studi_edit_save.php?kode='+kode+'&nama='+nama+'&kodehid='+kodehid+'&namahid='+namahid,
                                type: 'GET',
                                success: function (data){               
                                  ...
                                  refresh();
                                  $("#tablebidang_studi").load('pages/bidang_studi/bidang_studi_load.php');
            ...
            $(document).ready(function (){
                 $("#tablebidang_studi").load('pages/bidang_studi/bidang_studi_load.php');
                    ...
                    $("#formbidang_studi").on('submit', function(e){
                          e.preventDefault();
                                      $.ajax({
                                                  type: 'POST',
                                                  url: 'pages/bidang_studi/bidang_studi_add_save.php',
