      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-info">
            ...
            /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" enctype="multipart/form-data" novalidate id="formjurusan">
              <div class="box-body">
...
<script>  
          refresh();
            ...
            function simpanubah(){
                  ...
                  //alert('pages/jurusan/jurusan_edit_save.php?kode='+kode+'&nama='+nama+'&kodehid='+kodehid+'&namahid='+namahid);
                   $.ajax({
                                url: 'pages/jurusan/jurusan_edit_save.php?kode='+kode+'&nama='+nama+'&kodehid='+kodehid+'&namahid='+namahid,
                                type: 'GET',
                                success: function (data){               
                                  ...
                                  refresh();
                                  $("#tablejurusan").load('pages/jurusan/jurusan_load.php');
                 ...
                 $("#tablejurusan").load('pages/jurusan/jurusan_load.php');
                    ...
                    $("#formjurusan").on('submit', function(e){
                          e.preventDefault();
                                      $.ajax({
                                                  type: 'POST',
                                                  url: 'pages/jurusan/jurusan_add_save.php',
