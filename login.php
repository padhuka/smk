...
<head>
  ...
  <title>Sistem Informasi Pembayaran Sekolah - SMKS Muhammadiyah 9 Gambiran</title>
...
<div class="login-logo">
    ...
    <form  class="form-horizontal" enctype="multipart/form-data" novalidate id="fupForm">
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" onclick="myFunction()">Sign In</button>
